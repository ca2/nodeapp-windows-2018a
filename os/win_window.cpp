...
namespace win
{
   ...
   window::window(::ca::applicationsp papp) :
      ca(papp),
...
#define new DEBUG_NEW
   ...
   void window::message_handler(::ca::signal_object * pobj)
   {
      ...
      {
      ::ca::applicationsp* ppapp= (::ca::applicationsp*) pbase->m_lparam;
      *ppapp = get_app();
      pbase->m_bRet = true;
      return;
      }
...
restart_mouse_hover_check:
   ...
   */
   ...
   public:
      ...
      print_window(::ca::applicationsp papp, oswindow oswindow, HDC hdc, uint32_t dwTimeout) :
         ca(papp),
         m_event(papp)
      {
         m_event.ResetEvent();
