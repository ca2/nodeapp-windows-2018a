...
namespace win
{
   ...
   public:
      ...
      ::core::window_callback *         m_pcallback;
      ...
      bool create_message_window(const char * pszName, ::core::window_callback * pcallback = NULL);

      static const MSG* GetCurrentMessage();

      virtual void install_message_handling(message::dispatch * pinterface);

      bool operator==(const ::core::window& wnd) const;
      bool operator!=(const ::core::window& wnd) const;
      ...
      virtual sp(::core::window) from_os_data(void * pdata);
      virtual void * get_os_data() const;

      static sp(::core::window) from_handle(oswindow oswindow);
      static sp(::core::window) FromHandlePermanent(oswindow oswindow);
      ...
      bool SubclassDlgItem(UINT nID, sp(::core::window) pParent);
      ...
      // special pre-creation and ::core::window rect adjustment hooks
      ...
      static sp(::core::window) get_safe_owner(sp(::core::window) pParent = NULL, oswindow* pWndTop = NULL);

      virtual bool IsWindow();

   #if(WINVER >= 0x0500)

      sp(::core::window) GetAncestor(UINT gaFlags) const;
   ...
   // Window size and position Functions
      ...
      //static const ::core::window wndTop; // SetWindowPos's pWndInsertAfter
      //static const ::core::window wndBottom; // SetWindowPos's pWndInsertAfter
      //static const ::core::window wndTopMost; // SetWindowPos pWndInsertAfter
      //static const ::core::window wndNoTopMost; // SetWindowPos pWndInsertAfter
   ...
   // Coordinate Mapping Functions
      virtual void MapWindowPoints(sp(::core::window) pwndTo, LPPOINT lpPoint, UINT nCount);
      virtual void MapWindowPoints(sp(::core::window) pwndTo, LPRECT lpRect);
   ...
   // Window State Functions
      ...
      // the active ::core::window applies only to top-level (frame windows)
      virtual sp(::user::interaction) GetActiveWindow();
      virtual sp(::user::interaction) SetActiveWindow();

      // the foreground ::core::window applies only to top-level windows (frame windows)
      virtual bool SetForegroundWindow();
      static sp(::core::window) GetForegroundWindow();
      ...
      static sp(::core::window) GetCapture();
      ...
      static sp(::core::window) GetDesktopWindow();
   ...
   // (NOTE: Dialog-Box Items/Controls are not necessarily in dialog boxes!)
      ...
      virtual sp(::core::window) GetNextDlgGroupItem(sp(::core::window) pWndCtl, bool bPrevious = FALSE) const;
      virtual sp(::core::window) GetNextDlgTabItem(sp(::core::window) pWndCtl, bool bPrevious = FALSE) const;
   ...
   // Window Access Functions
      ...
      static sp(::core::window) FindWindow(const char * lpszClassName, const char * lpszWindowName);
      static sp(::core::window) FindWindowEx(oswindow oswindowParent, oswindow oswindowChildAfter, const char * lpszClass, const char * lpszWindow);
      ...
      sp(::core::window) set_parent(sp(::core::window) pWndNewParent);
      static sp(::core::window) WindowFromPoint(POINT point);
   ...
   // Clipboard Functions
      ...
      static sp(::core::window) GetClipboardOwner();
      static sp(::core::window) GetClipboardViewer();
      static sp(::core::window) GetOpenClipboardWindow();
   ...
   // Window-Management message handler member functions
      ...
      void OnActivate(UINT nState, sp(::core::window) pWndOther, bool bMinimized);
      void OnActivateApp(bool bActive, uint32_t dwThreadID);
      LRESULT OnActivateTopLevel(WPARAM, LPARAM);
      void OnCancelMode();
      void OnChildActivate();
      void OnClose();
      void OnContextMenu(sp(::core::window) pWnd, point pos);
      bool OnCopyData(sp(::core::window) pWnd, COPYDATASTRUCT* pCopyDataStruct);
      DECL_GEN_SIGNAL(_001OnCreate);


      HBRUSH OnCtlColor(::draw2d::graphics * pgraphics, sp(::core::window) pWnd, UINT nCtlColor);

      DECL_GEN_SIGNAL(_001OnDestroy);
      void OnEnable(bool bEnable);
      void OnEndSession(bool bEnding);
      void OnEnterIdle(UINT nWhy, sp(::core::window) pWho);
      bool OnEraseBkgnd(::draw2d::graphics * pgraphics);
      void OnGetMinMaxInfo(MINMAXINFO* lpMMI);
      bool OnHelpInfo(HELPINFO* lpHelpInfo);
      void OnIconEraseBkgnd(::draw2d::graphics * pgraphics);
      void OnKillFocus(sp(::core::window) pNewWnd);
      ...
      bool OnQueryOpen();
      void OnSetFocus(sp(::core::window) pOldWnd);
   ...
   // System message handler member functions
      ...
      void OnPaletteIsChanging(sp(::core::window) pRealizeWnd);
      ...
      void OnFontChange();
      void OnPaletteChanged(sp(::core::window) pFocusWnd);
   ...
   // Clipboard message handler member functions
      ...
      void OnHScrollClipboard(sp(::core::window) pClipAppWnd, UINT nSBCode, UINT nPos);
      void OnPaintClipboard(sp(::core::window) pClipAppWnd, HGLOBAL hPaintStruct);
      void OnRenderAllFormats();
      void OnRenderFormat(UINT nFormat);
      void OnSizeClipboard(sp(::core::window) pClipAppWnd, HGLOBAL hRect);
      void OnVScrollClipboard(sp(::core::window) pClipAppWnd, UINT nSBCode, UINT nPos);
   ...
   // MDI message handler member functions
      void OnMDIActivate(bool bActivate,
         sp(::core::window) pActivateWnd, sp(::core::window) pDeactivateWnd);
   ...
   // Win4 messages
      ...
      void OnCaptureChanged(sp(::core::window) pWnd);
...
//      virtual void do_data_exchange(CDataExchange* pDX);
   ...
   // Implementation
      ...
      static void _FilterToolTipMessage(MSG* pMsg, sp(::core::window) pWnd);
      ...
      int32_t m_nModalResult; // for return values from ::core::window::RunModalLoop
      ...
      bool CreateDlg(const char * lpszTemplateName, sp(::core::window) pParentWnd);
      //bool CreateDlgIndirect(LPCDLGTEMPLATE lpDialogTemplate, sp(::core::window) pParentWnd,
        // HINSTANCE hInst);
