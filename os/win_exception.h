...
namespace ca
{
   ...
   NOINLINE DECLSPEC_NO_RETURN inline void WINAPI gen_ThrowLastWin32(::ca::applicationsp papp)
   {
   ...
   // Throw a atl_exception corresponding to the result of ::GetLastError
   NOINLINE inline void WINAPI gen_ThrowLastWin32(::ca::applicationsp papp)
   {
      DWORD dwError = ::GetLastError();
      throw hresult_exception(papp, HRESULT_FROM_WIN32( dwError ) );
   }
