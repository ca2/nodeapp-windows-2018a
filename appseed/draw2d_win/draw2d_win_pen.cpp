...
/*      if (get_handle() == NULL)
   ...
   /*void __get_gray_bitmap(sp(::ca2::application) papp, const ::draw2d::bitmap &rSrc, ::draw2d::bitmap *pDest, COLORREF crBackground)
   {
      ASSERT(pDest);
...
//         pDest->delete_object();
   ...
   void __draw_gray_bitmap(sp(::ca2::application) papp, ::draw2d::graphics * pgraphics, int32_t x, int32_t y, const ::draw2d::bitmap &rSrc, COLORREF crBackground)
   {
      ASSERT(pgraphics);
   ...
   void __get_dithered_bitmap(sp(::ca2::application) papp, const ::draw2d::bitmap &rSrc, ::draw2d::bitmap *pDest, COLORREF cr1, COLORREF cr2)
   {
      ASSERT(pDest);
      ASSERT_KINDOF(::draw2d::bitmap, pDest);
   ...
   void __draw_dithered_bitmap(sp(::ca2::application) papp, ::draw2d::graphics * pgraphics, int32_t x, int32_t y, const ::draw2d::bitmap &rSrc, COLORREF cr1, COLORREF cr2)
   {
      ASSERT(pgraphics);
      ASSERT_KINDOF(::draw2d::graphics_sp, pgraphics);
