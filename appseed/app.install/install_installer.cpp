...
namespace install
{
   ...
   int installer::install(string strCommand)
   {
      ...
      get_command_line_param(m_strLocale, strCommand, "locale", "_std");

      get_command_line_param(m_strSchema, strCommand, "schema", m_strLocale);

      string strValue;

      m_bLaunch = get_command_line_param(strValue, strCommand, "enable_desktop_launch");
   ...
   ::file::path installer::ca2unbz_get_file(LPCSTR lpcszUrl)
   {
      ...
      path /= ::dir::afterca2() / "time/unbz"/ str;
