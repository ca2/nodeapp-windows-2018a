...
// bro      2002-10-29
//========================================================
void _SetString( LPSTR psz, LPSTR end, string* ps, bool trim = FALSE, int escape = 0 )
{
	//trim
	if( trim )
	{
...
string	_tagXMLNode::GetChildText( LPCSTR name, LPDISP_OPT opt /*= &optDefault*/ )
{
	LPXNode node = GetChild( name );
...
string _tagXMLEntitys::Ref2Entity( LPCSTR estr )
{
	string es;
	if( estr )
	{
...
string _tagXMLEntitys::Entity2Ref( LPCSTR str )
{
	string s;
	if( str )
	{
...
string XRef2Entity( LPCSTR estr )
{
	return entityDefault.Ref2Entity( estr );
}

string XEntity2Ref( LPCSTR str )
{
