...
/*extern "C"  typedef  void     ( *    LPFN_NS_PluginShutdown                )(void);
extern "C"  typedef  NPError  ( *    LPFN_fillNetscapeFunctionTable        )(NPNetscapeFuncs * aNPNFuncs);
extern "C"  typedef  NPError  ( *    LPFN_NS_PluginInitialize              )(void);
...
__declspec(dllexport) NPError NS_PluginInitialize(void);
__declspec(dllexport) void NS_PluginShutdown(void);
