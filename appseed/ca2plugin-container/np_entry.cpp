...
NPError OSCALL NP_Initialize(NPNetscapeFuncs* aNPNFuncs)
{
   ...
   //MessageBox(NULL, "boxinit", "box", MB_OK);

   //Sleep(15 * 1000);

   g_pvoidPluginSystem = NULL;

   NPError rv = _fillNetscapeFunctionTable(aNPNFuncs);
...
NPError OSCALL NP_GetEntryPoints(NPPluginFuncs* aNPPFuncs)
{
   ...
   return _fillPluginFunctionTable(aNPPFuncs);
